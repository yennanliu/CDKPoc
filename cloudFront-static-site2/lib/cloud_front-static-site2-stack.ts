...
// https://github.com/idanlupinsky/static-site-infra-demo/blob/main/lib/static-site-infra-demo-stack.ts

// export class CloudFrontStaticSite2Stack extends Stack {
//   constructor(scope: Construct, id: string, props?: StackProps) {
//     super(scope, id, props);
//     const queue = new sqs.Queue(this, 'CloudFrontStaticSite2Queue', {
//       visibilityTimeout: Duration.seconds(300)
//     });
//     const topic = new sns.Topic(this, 'CloudFrontStaticSite2Topic');
